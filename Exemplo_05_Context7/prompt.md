...
- Página Home ("Hello World") que mostra o estado: "Logado como <nome/imagem/email/nome>" OU "Você não está logado".
...
- Após login, Home mostra dados do usuário/sessão como imagem, nome e email.
